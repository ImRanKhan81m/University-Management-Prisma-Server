...
CREATE TABLE "students" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "academicsSemesterId" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "students" ADD CONSTRAINT "students_academicsSemesterId_fkey" FOREIGN KEY ("academicsSemesterId") REFERENCES "academic_semesters"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
